...
export default async function Inicio() {
  return (
    <>
      <h1 className="text-2xl text-white font-bold py-2">Inicio</h1>
      <div className="relative isolate overflow-hidden bg-gray-600 py-24 sm:py-32 rounded">
        <img
      ...
      <div className="bg-gray-800 rounded-sm shadow-md p-4 text-black bg-gray-600 text-gray-800 text-wrap">
        <h2 className="text-2xl text-white font-semibold text-center">Nosotros</h2>
        <p className="mt-20 text-white text-lg">
          MyBank fue fundado en 1973, en Michigan City, Indiana, Estados
