...
export default function Asside() {
  return (
    <>
      <aside
        className="w-60 text-white fixed h-screen bg-gray-50 bg-gray-900 mt-20 hidden z-50"
        id="aside1"
      ...
      <aside
        className="w-24 text-white fixed h-screen bg-gray-50 bg-gray-900 mt-20"
        id="aside2"
      >
