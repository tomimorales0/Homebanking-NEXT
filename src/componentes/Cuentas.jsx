...
export default function Cuentas() {
  return (
    <main
      className="flex pb-6 ml-24 text-wrap text-black dark:text-gray-300 dark:bg-gray-800 min-h-screen"
      id="main"
    >
      <div className="flex flex-col items-center w-full gap-5">
        ...
        <div className="flex flex-wrap lg:flex-nowrap 2xl:justify-around gap-2 w-full">
          <a
            ...
            className="m-4 border rounded-lg border-stone-400 p-8 flex flex-col gap-2 shadow-md shadow-stone-800/50 border-l-8 border-l-green-600 w-full max-w-[750px] dark:bg-gray-800 hover:bg-gray-600"
          >
