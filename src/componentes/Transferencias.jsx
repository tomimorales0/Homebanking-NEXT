export default function Transferencias() {
  return (
    <main
      className="flex ml-24 text-wrap text-black text-gray-300 min-h-screen"
      id="main"
    >
      <div className="flex flex-col items-center w-full gap-5 bg-gray-800">
        ...
        <ul
          role="list"
          className="divide-y divide-gray-100 w-full max-w-[800px] border-solid border-2 border-sky-500 border-gray-700 rounded-sm p-4"
          id="lista-contactos"
        >
